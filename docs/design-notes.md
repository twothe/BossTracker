...
- Pure aura-only repeats at nearly the same HP are hidden as likely passive, consequence, or phase-state noise unless future relevance logic has stronger evidence that they are player-actionable mechanics. Pure boss self-aura and boss-applied player-aura state are also hidden by default because they are primarily phase markers for the interpreter, not player-facing timers.
